    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="space-y-4">
          {filtered.length === 0 ? (
            <div className="bg-white rounded-xl shadow p-8 text-center text-gray-500">No reviews found</div>
          ) : (
            filtered.map((review) => (
              <div
                key={review.id}
                onClick={() => setSelected(review)}
                className={`bg-white rounded-xl shadow p-5 cursor-pointer transition hover:shadow-md border-2 ${
            ...
            <div className="bg-white rounded-xl shadow p-6">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div>
                  ...
                  <span className={`text-sm px-2 py-1 rounded-full font-medium ${statusBadge(selected.status)}`}>
                    {selected.status}
                  </span>
                </div>
                <div>
