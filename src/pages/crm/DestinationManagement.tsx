...
export default function DestinationManagement() {
 ...
 <div className="animate-spin h-12 w-12 border-b-2 border-red-600"></div>
 </div>
 );
 }
 ...
 {destination.video_url && (
 <span className="absolute top-2 left-2 bg-black/60 text-white text-xs font-semibold px-2 py-1 flex items-center gap-1">
 <Video className="h-3 w-3" /> Video
 </span>
 )}
 {destination.featured && (
 <span className="absolute top-2 right-2 bg-yellow-400 text-yellow-900 text-xs font-semibold px-2 py-1">
 Featured
 </span>
 )}
 ...
 className="w-full flex items-center justify-center px-3 py-2 bg-red-600 text-white hover:bg-red-700 transition text-sm font-medium"
 >
 ...
 className="flex-1 flex items-center justify-center px-3 py-2 bg-red-50 text-red-600 hover:bg-red-100 transition"
 >
 ...
 className="flex-1 flex items-center justify-center px-3 py-2 bg-red-50 text-red-600 hover:bg-red-100 transition disabled:opacity-40 disabled:cursor-not-allowed"
 ...
 className="absolute top-2 right-2 bg-white p-1 shadow hover:bg-red-50 transition"
 >
 ...
 src={videoPreview}
 controls
 className="w-full max-h-48 border border-gray-200 object-cover"
 />
 <button
 type="button"
 onClick={() => {
