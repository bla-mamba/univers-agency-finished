...
export default function HeroMediaManagement() {
 ...
 <div className="w-8 h-8 border-4 border-red-600 border-t-transparent animate-spin" />
 </div>
 );
 }
 ...
 return (
 <div key={hero.id} className="bg-white shadow-sm border border-gray-100 overflow-hidden">
 <div className="p-6">
 ...
 <span className={`inline-flex items-center gap-1 text-xs font-medium px-2 py-0.5 mt-1 ${
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-gray-600 hover:bg-gray-100 transition"
 >
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-red-600 hover:bg-red-50 transition"
 >
 ...
 <div className="mt-4 overflow-hidden h-48 relative bg-gray-900">
 {hero.media_type === 'video' ? (
 ...
 className={`flex items-center gap-2 px-4 py-2 border text-sm font-medium transition ${
 ...
 <div className="flex border border-gray-200 overflow-hidden w-fit mb-3">
 <button
 ...
 className="w-full border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
 />
 )}
 ...
 className="w-full border-2 border-dashed border-gray-200 px-4 py-6 flex flex-col items-center gap-2 text-gray-500 hover:border-red-400 hover:text-red-500 transition"
 >
 ...
 {livePreviewUrl && (
 <div className="overflow-hidden h-48 relative bg-gray-900">
 ...
 className="flex items-center gap-2 px-4 py-2 bg-red-600 text-white text-sm font-semibold hover:bg-red-700 transition disabled:opacity-60"
 >
 {(saving || uploading) ? (
 ...
 onClick={cancelEdit}
 disabled={saving || uploading}
 className="flex items-center gap-2 px-4 py-2 border border-gray-200 text-gray-600 text-sm font-medium hover:bg-gray-50 transition disabled:opacity-60"
 >
 <X className="h-4 w-4" />
 Cancel
 </button>
