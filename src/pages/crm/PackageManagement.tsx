...
export default function PackageManagement() {
 ...
 max_group_size: formData.max_group_size && parseInt(formData.max_group_size) > 0 ? parseInt(formData.max_group_size) : null,
 ...
 max_group_size: data.max_group_size ? data.max_group_size.toString() : '',
 ...
 <div className="h-12 w-16 bg-gray-100 flex items-center justify-center">
 ...
 className="inline-flex items-center gap-1 px-2 py-1 bg-blue-50 text-blue-700 hover:bg-blue-100 transition text-xs font-medium"
 ...
 className="inline-flex items-center gap-1 px-2 py-1 bg-yellow-50 text-yellow-700 hover:bg-yellow-100 transition text-xs font-medium"
 ...
 className="absolute top-1 right-1 bg-red-600 text-white p-0.5 opacity-80 hover:opacity-100 transition"
 >
 <X className="h-3 w-3" />
 </button>
 </div>
 ...
 >
 {uploading && <div className="w-4 h-4 border-2 border-white border-t-transparent animate-spin" />}
