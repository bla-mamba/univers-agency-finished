...
`)
 ...
 {packages.map((pkg) => (
 <div key={pkg.id} className="bg-white shadow-sm overflow-hidden">
 ...
 className="mt-4 block w-full bg-red-600 text-white py-2.5 text-sm font-semibold hover:bg-red-700 transition"
 >
 Book This Package
 </Link>
 </div>
 ...
 <div className="mt-6 sm:mt-8 bg-white shadow-sm overflow-hidden hidden sm:block">
