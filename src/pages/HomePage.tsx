...
const PROCESS_STEPS = [
  {
    step: '01',
    title: 'Na tregoni çfarë kërkoni',
    desc: 'Fillojmë me një bisedë të thjeshtë — ku dëshironi të shkoni, kur dhe sa persona jeni. Nuk është e nevojshme t’i keni të gjitha të vendosura; e ndërtojmë bashkë.',
  },
  {
    step: '02',
    title: 'Përgatisim një plan për ju',
    desc: 'Ju dërgojmë një propozim konkret me hotelin, transportin dhe programin ditor — të menduar sipas nevojave tuaja, jo si një paketë standarde për këdo.',
  },
  {
    step: '03',
    title: 'Kujdesemi për çdo detaj',
    desc: 'Fluturimet, hotelet, transfertat dhe guidat i koordinojmë ne. Ju merrni gjithçka të konfirmuar qartë dhe me shkrim, pa pasur nevojë të ndiqni disa kontakte njëkohësisht.',
  },
  {
    step: '04',
    title: 'Jemi pranë jush gjatë udhëtimit',
    desc: 'Nëse ndodh diçka gjatë rrugës, keni një person real në telefon që e njeh rezervimin tuaj. Jo një qendër thirrjesh — por kontakti juaj i dedikuar.',
  },
];
...
const EXPERTISE_REGIONS = [
  {
    ...
    description:
      'Kjo është zona që e njohim më mirë. Kemi transportin tonë tokësor, kemi vizituar vetë hotelet dhe punojmë drejtpërdrejt me partnerë lokalë në të gjithë rajonin.',
    image:
  ...
  },
  {
    ...
    description:
      'Bashkëpunojmë me partnerë lokalë me përvojë në Greqi, Kroaci dhe Itali. Akomodim i verifikuar, çmime të qarta dhe mbështetje reale nëse lind ndonjë situatë e papritur.',
    image:
      'https://images.pexels.com/photos/1285625/pexels-photo-1285625.jpeg?auto=compress&cs=tinysrgb&w=1200',
  },
  {
    region: 'Destinacione botërore',
    countries: 'Azi · Amerikë · Afrikë · Lindja e Mesme',
    description:
      'Jemi të akredituar nga IATA për biletim ndërkombëtar dhe bashkëpunojmë me agjenci partnere në çdo kontinent. I njëjti kujdes dhe e njëjta transparencë, pavarësisht sa larg udhëtoni.',
    image:
...
const TESTIMONIALS = [
  {
    ...
    text: 'Udhëtuam 45 persona në Mal të Zi dhe Shqipëri për një event të kompanisë. Autobusët ishin në kohë, hotelet ishin pikërisht siç na ishin prezantuar dhe gjatë gjithë udhëtimit gjithçka shkoi pa probleme. Organizim i shkëlqyer.',
    rating: 5,
  },
  {
    name: 'Mirela Basha',
    role: 'Muaj mjalti, Mesdhe',
    text: 'Hotelet ishin të shkëlqyera dhe guidat shumë profesionale. Kur trageti u vonua, Univers e zgjidhi situatën përpara se ne të kishim kohë të shqetësoheshim. Ndihesh i qetë kur ke dikë që kujdeset vërtet.',
    rating: 5,
  },
  {
    name: 'Dritan Kola',
    role: 'Drejtor, Kryqi i Kuq Shqiptar',
    text: 'Punojmë me Univers prej katër vitesh. Çmimet janë të qarta, e njohin rajonin shumë mirë dhe nuk zhduken pas konfirmimit të rezervimit. Kjo lloj besueshmërie ka vlerë të madhe kur menaxhon udhëtime për organizata.',
    rating: 5,
  },
];
...
const TRAVEL_TIPS = [
  {
    icon: FileCheck,
    title: 'Kontrolloni pasaportën që tani',
    desc: 'Shumë vende nuk lejojnë hyrjen nëse pasaporta skadon brenda 6 muajve nga data e kthimit. Rinovimi shpesh merr kohë, ndaj mos e lini për momentin e fundit.',
    tag: 'Dokumente',
  },
  {
    icon: AlertTriangle,
    title: 'Sigurimi i udhëtimit vlen gjithmonë',
    desc: 'Një emergjencë mjekësore ose evakuim mund të kushtojë shumë më tepër sesa mendohet. Sigurimi i udhëtimit është një kosto e vogël krahasuar me mbrojtjen që ofron.',
    tag: 'Siguri',
  },
  {
    icon: Plane,
    title: 'Sezoni i verës mbushet shpejt',
    desc: 'Korriku dhe gushti në bregdetin shqiptar dhe malazez rezervohen shumë herët. Hotelet më të mira zënë vend që në pranverë, ndaj planifikimi i hershëm bën diferencën.',
    tag: 'Planifikim',
  },
  {
    icon: Hotel,
    title: 'Katër yje nuk nënkuptojnë të njëjtën gjë kudo',
    desc: 'Një hotel me 4 yje në Ballkan mund të jetë shumë i ndryshëm nga një hotel me të njëjtin klasifikim në Europën Perëndimore. Ne i verifikojmë vetë akomodimet që rekomandojmë.',
    tag: 'Akomodim',
  },
];
...
const COMMITMENTS = [
  {
    ...
    desc: 'Lëshojmë bileta ajrore drejtpërdrejt si agjenci e akredituar nga IATA. Kjo do të thotë standarde ndërkombëtare dhe siguri më e lartë për klientin.',
  },
  {
    icon: Award,
    title: 'Certifikim Travelife',
    desc: 'Travelife është një certifikim i pavarur për turizëm të qëndrueshëm, i verifikuar përmes auditimeve periodike. Nuk është vetëdeklarim — është standard i provuar.',
  },
  {
    icon: DollarSign,
    title: 'Çmime të qarta',
    desc: 'Çmimi që ju paraqesim është çmimi që paguani. Çdo kosto specifikohet qartë me shkrim përpara se të merrni vendimin final.',
  },
  {
    icon: Leaf,
    title: 'Turizëm me përgjegjësi',
    desc: 'Preferojmë partnerë lokalë, transport të organizuar me kujdes dhe zgjidhje që respektojnë mjedisin dhe komunitetet ku operojmë.',
  },
];
...
export default function HomePage() {
  ...
  const [allPackages, setAllPackages] = useState<
    { id: string; title: string; slug: string; destination: { name: string; country: string } | null }[]
  >([]);
  ...
  useEffect(() => {
    ...
    const pkgMatches: SearchSuggestion[] = allPackages
      ...
      .map((p) => ({
        ...
        id: p.id,
        label: p.title,
        sublabel: p.destination ? `${p.destination.name}, ${p.destination.country}` : '',
        slug: p.slug,
      }));
  ...
  const loadSearchData = async () => {
    const [destsRes, pkgsRes] = await Promise.all([
      ...
      supabase
        .from('packages')
        .select('id, title, slug, destination:destinations(name, country)')
        .eq('status', 'published'),
    ]);
  ...
  const loadFeaturedPackages = async () => {
    try {
      const { data, error } = await supabase
        .from('packages')
        .select(
          `id, title, slug, price, original_price, duration_days, images, video_url, featured, destination:destinations(name, country)`
        )
        .eq('status', 'published')
        .eq('featured', true)
        .limit(6);
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full pb-14">
            <div className="mb-10">
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-white leading-[1.0] tracking-tight mb-6 max-w-4xl">
                Udhëtoni pa stres.
                <br />
                Për pjesën tjetër kujdesemi ne.
              </h1>
              <p className="text-lg text-white/70 font-light max-w-2xl leading-relaxed">
                Organizojmë udhëtime për familje, çifte dhe grupe — në Ballkan, Mesdhe dhe
                destinacione në mbarë botën.
              </p>
            </div>

            <form
              onSubmit={handleSearch}
              className="bg-white/[0.06] backdrop-blur-md border border-white/15 p-1 w-full max-w-4xl"
            >
              <div className="grid grid-cols-2 md:grid-cols-4 gap-0">
                <div className="relative col-span-2 md:col-span-1 border-r border-white/15" ref={searchRef}>
                  ...
                  <input
                    type="text"
                    placeholder="Ku dëshironi të udhëtoni?"
                    value={searchQuery}
                    onChange={(e) => {
                  ...
                  {showSuggestions && suggestions.length > 0 && (
                    <div
                      className="absolute left-0 right-0 bottom-full mb-1 bg-white border border-gray-200 shadow-2xl z-[9999] overflow-hidden"
                      style={{ minWidth: '100%' }}
                    >
                        ...
                        >
                          <span
                            className={`flex-shrink-0 w-7 h-7 flex items-center justify-center ${
                              s.type === 'destination' ? 'bg-red-50' : 'bg-gray-50'
                            }`}
                          >
                            {s.type === 'destination' ? (
                ...
                <div className="relative col-span-1 border-r border-white/15" ref={dateRef}>
                  ...
                  >
                    ...
                    <span className={searchDate ? 'text-white' : 'text-white/40'}>
                      {searchDate
                        ? new Date(searchDate + 'T00:00:00').toLocaleDateString('sq-AL', {
                            day: '2-digit',
                            month: 'short',
                            year: 'numeric',
                          })
                    ...
                    <svg
                      className={`ml-auto h-4 w-4 text-white/40 transition-transform duration-200 ${
                  ...
                  {showDateDropdown && (
                    <div
                      className="absolute left-0 bottom-full mb-1 bg-white border border-gray-200 shadow-2xl z-[9999] overflow-hidden"
                ...
                <div className="relative col-span-1 border-r border-white/15" ref={travelersRef}>
                  ...
                  {showTravelersDropdown && (
                    ...
                    >
                      ...
                      {[
                        { value: '1', label: 'Individual', sub: '1 udhëtar' },
                        ...
                        <button
                          ...
                          type="button"
                          onClick={() => {
                            setSearchTravelers(opt.value);
                            setShowTravelersDropdown(false);
                          }}
                          className={`w-full flex items-center gap-3 px-4 py-3 hover:bg-gray-50 transition text-left border-b border-gray-50 last:border-0 ${
                            searchTravelers === opt.value ? 'bg-red-50' : ''
                          }`}
                        >
                          <span className="flex-1">
                            <span
                              className={`block text-sm font-semibold ${
                                searchTravelers === opt.value ? 'text-red-600' : 'text-gray-900'
                              }`}
                            >
                              {opt.label}
                            </span>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-14 gap-4">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.3em] text-red-600 mb-4">
                Paketa udhëtimi
              </p>
              ...
              <p className="text-gray-500 mt-3 max-w-lg text-base leading-relaxed">
                Disa nga paketat më të kërkuara nga klientët tanë. Program i qartë, çmime
                transparente dhe hotele të përzgjedhura me kujdes.
              </p>
            </div>

            <Link
              to="/packages"
              className="inline-flex items-center gap-2 text-sm font-bold text-red-600 hover:text-red-700 transition uppercase tracking-wider whitespace-nowrap border-b-2 border-red-600 pb-0.5"
            >
          ...
          {loading ? (
            ...
            <div className="text-center py-16 text-gray-400 border border-gray-100">
              Nuk ka paketa të përzgjedhura për momentin.
            </div>
          )}
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="px-10 lg:px-16 py-20 flex flex-col justify-center">
              <p className="text-xs font-bold uppercase tracking-[0.3em] text-red-500 mb-6">
                Rreth Univers
              </p>
              ...
              <p className="text-gray-400 text-base leading-relaxed mb-5">
                Organizojmë udhëtime për familje, çifte, kompani dhe institucione. Paketa
                turistike, bileta avioni, transport për grupe dhe programe të personalizuara —
                të gjitha të menaxhuara nga i njëjti ekip, nga fillimi deri në fund.
              </p>
              <p className="text-gray-500 leading-relaxed mb-10 text-sm">
                Jemi agjenci e akredituar nga IATA dhe e certifikuar nga Travelife. Punojmë me
                partnerë të besueshëm dhe hotele të verifikuara në Ballkan, Mesdhe dhe shumë
                destinacione të tjera.
              </p>
              <div className="flex flex-wrap gap-3">
                <Link
                  to="/about"
                  className="inline-flex items-center gap-2 bg-red-600 text-white px-7 py-3.5 hover:bg-red-700 transition font-semibold text-sm tracking-wide uppercase"
                >
                  Rreth nesh <ChevronRight className="h-4 w-4" />
                </Link>
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 border border-white/20 text-white px-7 py-3.5 hover:border-white/40 hover:bg-white/5 transition font-semibold text-sm tracking-wide uppercase"
                >
                  Kontakt
                </Link>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-0 divide-y md:divide-y-0 md:divide-x divide-red-500">
            {[
              {
                icon: CheckCircle,
                label: 'Çmime të qarta',
                sub: 'Çdo kosto konfirmohet me shkrim përpara pagesës. Nuk ka tarifa të fshehura që shfaqen pas konfirmimit.',
              },
              {
                icon: HeadphonesIcon,
                label: 'Kontakt real dhe i drejtpërdrejtë',
                sub: 'Keni një person që e njeh rezervimin tuaj — jo një qendër thirrjesh. Mund të na kontaktoni gjatë gjithë udhëtimit.',
              },
              {
                icon: Shield,
                label: 'Akreditim IATA',
                sub: 'Lëshojmë bileta ajrore drejtpërdrejt si agjenci e akredituar, sipas standardeve ndërkombëtare të industrisë.',
              },
              {
                icon: Leaf,
                label: 'Certifikim Travelife',
                sub: 'Një certifikim i pavarur, i audituar rregullisht. Jo deklaratë marketingu, por standard i verifikuar.',
              },
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mb-16">
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-950">Destinacionet tona</h2>
              <p className="text-gray-500 max-w-lg text-sm leading-relaxed">
                Punojmë vetëm me destinacione që i njohim mirë dhe ku kemi partnerë lokalë të
                besueshëm. Nuk ofrojmë paketa të pa verifikuara nga katalogë anonimë.
              </p>
            </div>
          </div>
      ...
      <section className="py-24 bg-gray-50 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-950 mb-3">
              Nga ideja deri te udhëtimi
            </h2>
            <p className="text-gray-500 max-w-2xl text-sm leading-relaxed">
              Procesi ynë është i thjeshtë: komunikim i qartë, partnerë të besueshëm dhe një
              person përgjegjës që ju ndjek nga biseda e parë deri në kthimin tuaj.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0 border border-gray-200">
            {PROCESS_STEPS.map((s, idx) => (
              <div
                key={s.step}
                className={`p-8 ${
                  idx < 3 ? 'border-b lg:border-b-0 lg:border-r border-gray-200' : ''
                } ${idx === 1 ? 'border-b sm:border-b-0 sm:border-r lg:border-r lg:border-b-0' : ''}`}
              >
                <p className="text-6xl font-black text-gray-100 leading-none mb-6 select-none">
                  {s.step}
                </p>
                <div className="w-6 h-0.5 bg-red-600 mb-5" />
                <h3 className="text-base font-bold text-gray-950 mb-3 uppercase tracking-wide">
                  {s.title}
                </h3>
        ...
        <div className="relative h-full flex items-center">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full">
            <div className="max-w-2xl">
              <p className="text-xs font-bold uppercase tracking-[0.35em] text-amber-400 mb-6">
                Udhëtime për korporata dhe grupe
              </p>
              ...
              >
                Kërkoni një ofertë për grupin <ChevronRight className="h-4 w-4" />
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mb-16">
            <p className="text-xs font-bold uppercase tracking-[0.3em] text-red-500 mb-4">
              Standarde dhe akreditime
            </p>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-3">
              Pse mund të na besoni
            </h2>
            <p className="text-gray-500 max-w-2xl text-sm leading-relaxed">
              Akreditimet dhe certifikimet tona nuk janë thjesht simbole — ato verifikohen nga
              organizma të pavarur dhe pasqyrojnë mënyrën se si punojmë çdo ditë.
            </p>
          </div>
      ...
      <section className="py-24 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-950 mb-3">
              Disa gjëra që ia vlen t’i dini
            </h2>
            <p className="text-gray-500 max-w-2xl text-sm leading-relaxed">
              Ka disa detaje që bëjnë vërtet diferencën përpara një udhëtimi. Këto janë
              këshillat që ua japim më shpesh klientëve tanë.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-100">
            {TRAVEL_TIPS.map(({ icon: Icon, title, desc, tag }) => (
              <div key={title} className="bg-white p-8 hover:bg-gray-50 transition-colors duration-300">
                ...
                <h3 className="text-sm font-bold text-gray-950 mb-3 uppercase tracking-wide leading-snug">
                  {title}
                </h3>
                <p className="text-gray-500 text-sm leading-relaxed">{desc}</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="relative h-80 lg:h-auto overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <p className="text-5xl font-black text-white/10 uppercase tracking-widest text-center leading-none">
                  KONTAKT
                </p>
              </div>
            </div>
            ...
            <div className="px-10 lg:px-16 py-20 flex flex-col justify-center">
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-10">
                Nuk është e nevojshme t’i keni të gjitha të planifikuara. Na kontaktoni dhe e
                ndërtojmë bashkë — nga datat dhe destinacioni, deri te çdo detaj i udhëtimit.
              </p>
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  ...
                  <div>
                    <p className="text-xs text-gray-600 font-bold uppercase tracking-widest mb-0.5">
                      Telefononi
                    </p>
      ...
      {/* PARTNER LOGOS */}
      <section className="py-12 border-t border-white/5 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <p className="text-center text-xs font-bold uppercase tracking-[0.3em] text-gray-700 mb-8">
            Akreditime & anëtarësi
          </p>

          <div className="hidden md:flex items-center justify-center gap-12">
            <img
              src="https://elitetravel-albania.com/wp-content/uploads/2025/06/Travel-Life.png"
              alt="Travel Life"
              className="h-9 w-auto object-contain"
            />
            <img
              src="https://elitetravel-albania.com/wp-content/uploads/2025/06/IATA.png"
              alt="IATA"
              className="h-9 w-auto object-contain"
            />
            <img
              src="https://elitetravel-albania.com/wp-content/uploads/2025/06/Travel.png"
              alt="Travel"
              className="h-9 w-auto object-contain"
            />
            <img
              src="https://elitetravel-albania.com/wp-content/uploads/2025/06/GIN.png"
              alt="GIN"
              className="h-9 w-auto object-contain"
            />
            <img
              src="https://elitetravel-albania.com/wp-content/uploads/2025/06/Clia.png"
              alt="Clia"
              className="h-9 w-auto object-contain"
            />
          </div>
