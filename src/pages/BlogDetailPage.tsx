...
export default function BlogDetailPage() {
 ...
 <article className="bg-white border border-gray-100 shadow-sm p-8 md:p-12">
 ...
 {post.tags.map((tag, i) => (
 <span key={i} className="bg-gray-100 text-gray-600 text-xs px-3 py-1.5 font-medium">
 {tag}
 </span>
 ))}
 </div>
 ...
 key={r.id}
 to={`/blog/${r.slug}`}
 className="bg-white overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition group flex flex-col"
 >
