...
const contactInfo = [
  ...
  },
  {
    icon: Clock,
    title: 'Orari i punës',
    lines: ['E Hënë – E Premte: 09:00 – 19:00', 'E Shtunë – E Diel: 10:00 – 16:00'],
    href: null,
  },
];
      ...
      <div className="relative h-[420px] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 h-full flex flex-col justify-end pb-14">
          ...
          <p className="text-white/70 max-w-xl leading-relaxed text-base font-light">
            Kontaktoni drejtpërdrejt ekipin tonë me telefon ose email. Ju përgjigjemi shpejt
            dhe ju këshillojmë për disponueshmërinë, çmimet dhe organizimin e çdo lloj
            udhëtimi.
          </p>
        </div>
      </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-gray-950 p-7">
              ...
              <h3 className="text-lg font-bold text-white mb-2">
                Keni nevojë për ndihmë urgjente gjatë udhëtimit?
              </h3>
              <p className="text-white/60 text-sm mb-5 leading-relaxed">
                Ekipi ynë operacional është i disponueshëm edhe jashtë orarit zyrtar për
                klientët që janë aktualisht në udhëtim ose pjesë e një programi të organizuar.
              </p>
              <a
