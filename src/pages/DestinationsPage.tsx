      ...
      <div className="relative h-[420px] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 h-full flex flex-col justify-end pb-14">
          ...
          <p className="text-white/70 max-w-xl leading-relaxed text-base font-light">
            Çdo destinacion që ofrojmë është parë dhe vlerësuar nga ekipi ynë. Hotelet,
            transporti dhe organizimi i udhëtimit verifikohen përpara se të bëhen pjesë e
            ofertës sonë.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10 pb-6 border-b border-gray-200">
          <h2 className="text-2xl font-bold text-gray-900 tracking-tight">
            Lista e destinacioneve
          </h2>
          <div className="relative w-full sm:w-72">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 h-4 w-4" />
            <input
              type="text"
              placeholder="Kërkoni sipas qytetit ose shtetit..."
              value={searchTerm}
              ...
              <div className="mb-14">
                <div className="flex items-center gap-4 mb-6 flex-wrap">
                  ...
                  <span className="text-xs text-gray-400">
                    — destinacionet ku kemi më shumë përvojë dhe programe të konsoliduara
                  </span>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.35em] text-red-600 mb-4">
                  Si i përzgjedhim destinacionet
                </p>
                <h2 className="text-4xl font-bold text-gray-900 mb-6 leading-tight tracking-tight">
                  Si bëhen pjesë e portofolit tonë
                </h2>
                <p className="text-gray-500 text-sm leading-relaxed mb-4">
                  Nuk i listojmë destinacionet vetëm mbi bazën e popullaritetit apo kërkesave
                  të partnerëve. Çdo vend që përfshihet në portofolin tonë kalon përmes një
                  vlerësimi operacional të plotë: krijohen marrëdhëniet me furnizuesit,
                  shqyrtohen standardet e akomodimit dhe testohet logjistika e itinerarit.
                </p>
                <p className="text-gray-500 text-sm leading-relaxed mb-8">
                  Ky proces zakonisht zgjat disa muaj për secilin destinacion. Rezultati është
                  një portofol më i përzgjedhur, por më i besueshëm — ku çdo program që
                  ofrojmë është verifikuar për të funksionuar sipas standardit që u garantojmë
                  klientëve tanë.
                </p>
                <Link
                  to="/about"
                ...
                >
                  Më shumë për metodologjinë tonë <ChevronRight className="h-4 w-4" />
                </Link>
              </div>
              ...
              <div className="border border-gray-200">
                {[
                  {
                    step: '01',
                    title: 'Vlerësim në terren',
                    desc: 'Ekipi ynë viziton çdo destinacion për të vlerësuar cilësinë e akomodimit, rrugët e transfertave, aksesin në vendndodhje dhe standardet e shërbimit në terren.',
                  },
                  {
                    step: '02',
                    title: 'Verifikimi i furnizuesve',
                    desc: 'Hotelet, transportuesit lokalë dhe guidat kontraktohen vetëm pasi plotësojnë standardet tona të besueshmërisë, cilësisë dhe komunikimit.',
                  },
                  {
                    step: '03',
                    title: 'Testimi i itinerarit',
                    desc: 'Programet e hartuara testohen përpara publikimit — koha, logjistika dhe aktivitetet e përfshira verifikohen në praktikë.',
                  },
                  {
                    step: '04',
                    title: 'Rishikim i vazhdueshëm',
                    desc: 'Destinacionet aktive rishikohen periodikisht. Ndryshimet te furnizuesit, problemet me infrastrukturën ose ulja e cilësisë së shërbimit sjellin rivlerësim.',
                  },
                ].map((item, i, arr) => (
                  <div
                    key={item.step}
                  ...
                  >
                    <span className="text-xs font-bold text-red-600 flex-shrink-0 pt-0.5">
                      {item.step}
                    </span>
                    <div>
                      <p className="text-sm font-bold text-gray-900 mb-1 uppercase tracking-wide">
                        {item.title}
                      </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.35em] text-amber-400 mb-3">
              Kërkesa të personalizuara
            </p>
            <h3 className="text-2xl font-bold text-white leading-tight mb-1 tracking-tight">
              Po kërkoni një destinacion që nuk është në këtë listë?
            </h3>
            <p className="text-white/50 text-sm max-w-md">
              Në shumë raste mund të vlerësojmë dhe të ndërtojmë një program të personalizuar
              brenda pak javësh për destinacione të njohura.
            </p>
          </div>
          <Link
            to="/contact"
    ...
    >
      <div className="relative h-56 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5">
          ...
          <div className="flex items-center gap-1 text-xs text-white/70 mt-1 uppercase tracking-wide">
      ...
      <div className="p-5 flex flex-col flex-1 border-b border-l border-r border-gray-100">
        <p className="text-gray-500 text-sm leading-relaxed line-clamp-2 flex-1">
          {destination.description ||
            'Një destinacion i përzgjedhur me kujdes, me programe të organizuara plotësisht dhe të disponueshme sipas kërkesës.'}
        </p>
