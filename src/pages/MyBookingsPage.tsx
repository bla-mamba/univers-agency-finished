...
'https://images.pexels.com/photos/1285625/pexels-photo-1285625.jpeg?auto=compress&cs=tinysrgb&w=400';
 ...
 return (
 <div key={booking.id} className="bg-white shadow-sm overflow-hidden flex flex-col sm:flex-row">
 ...
 <span className={`px-3 py-1 text-xs font-semibold ${sc.bg} ${sc.text}`}>
 {sc.label}
 </span>
 <span className={`px-3 py-1 text-xs font-semibold ${pc.bg} ${pc.text}`}>
 {pc.label}
 </span>
 </div>
 </div>
 ...
 <div className="bg-gray-50 px-4 py-2.5 text-sm text-gray-600 border border-gray-100">
