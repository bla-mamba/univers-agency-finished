      ...
      <div className="relative h-[480px] overflow-hidden bg-gray-900">
        ...
        {!pkg.video_url && images.length > 1 && (
          <>
            ...
            <button onClick={nextImage} className="absolute right-4 top-1/2 -translate-y-1/2 bg-black/40 hover:bg-black/60 text-white rounded-full p-2 transition">
              <ChevronRight className="h-6 w-6" />
            </button>
            <div className="absolute bottom-20 left-1/2 -translate-x-1/2 flex gap-2">
              {images.map((_, i) => (
                <button key={i} onClick={() => setActiveImage(i)} className={`w-2 h-2 rounded-full transition ${i === activeImage ? 'bg-white scale-125' : 'bg-white/50'}`} />
              ))}
            </div>
          </>
        )}
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap items-center gap-2 mb-3">
            {pkg.featured && <span className="bg-red-600 text-white text-xs px-3 py-1 rounded-full font-semibold">Featured</span>}
            {pkg.category && (
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {pkg.inclusions && pkg.inclusions.length > 0 && (
                <div className="bg-white rounded-xl shadow-sm p-6">
                  <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <span className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center"><Check className="h-4 w-4 text-green-600" /></span>
                    What's Included
                  </h3>
              ...
              {pkg.exclusions && pkg.exclusions.length > 0 && (
                <div className="bg-white rounded-xl shadow-sm p-6">
                  <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <span className="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center"><X className="h-4 w-4 text-red-500" /></span>
                    Not Included
                  </h3>
                  <ul className="space-y-2">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-3 text-xs text-gray-500">
                  ...
                  <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded-full bg-orange-400 inline-block"></span>Limited</span>
                  <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded-full bg-red-300 inline-block"></span>Full/Blocked</span>
                </div>
              </div>
            ...
            {bookingSuccess ? (
              <div className="p-8 text-center">
                ...
                <button
                  ...
                  className="bg-red-600 text-white px-6 py-2.5 rounded-xl font-semibold hover:bg-red-700 transition text-sm"
                >
                  Close
                </button>
              </div>
              ...
              <form onSubmit={submitBooking} className="p-6 space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-red-600 text-white py-3 rounded-xl font-semibold hover:bg-red-700 transition text-sm disabled:opacity-60"
                >
