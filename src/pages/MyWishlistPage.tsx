...
`)
 ...
 <Link
 to="/packages"
 className="inline-block bg-red-600 text-white px-6 py-3 font-semibold hover:bg-red-700 transition text-sm"
 >
 Explore Packages
 </Link>
 </div>
...
'https://images.pexels.com/photos/1285625/pexels-photo-1285625.jpeg?auto=compress&cs=tinysrgb&w=600';
 ...
 return (
 <div key={item.id} className="bg-white shadow-sm overflow-hidden group hover:shadow-lg transition">
 ...
 className="w-9 h-9 bg-white/90 backdrop-blur-sm flex items-center justify-center shadow hover:bg-red-50 transition group/btn"
 ...
 {pkg.category && (
 <span className="bg-gray-100 text-gray-600 text-xs px-2 py-0.5">
 {pkg.category.name}
 </span>
 )}
 </div>
 ...
 className="block w-full text-center bg-red-600 text-white py-2.5 text-sm font-semibold hover:bg-red-700 transition"
 >
 View Package
 </Link>
 </div>
