...
export default function CompareBar() {
 ...
 <div
 key={pkg.id}
 className="flex items-center gap-1.5 sm:gap-2 bg-gray-100 px-2 sm:px-3 py-1.5 sm:py-2 flex-shrink-0 min-w-0"
 >
 ...
 <div className="hidden sm:flex items-center gap-2 border-2 border-dashed border-gray-300 px-4 py-2 text-gray-400 text-sm flex-shrink-0">
 + Add package
 </div>
 )}
 </div>
 ...
 <Link
 to="/compare"
 className="bg-red-600 text-white px-5 py-2 text-sm font-semibold hover:bg-red-700 transition"
 >
 Compare Now
 </Link>
 )}
